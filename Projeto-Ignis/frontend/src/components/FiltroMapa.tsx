  ...
  return (
    <FiltroContainer>
      <Filtros>
        ...
        <Select id="id_estado" value={estado} onChange={(e) => {
          const value = e.target.value;
          setEstado(value === '' ? '' : parseInt(value));
        }}>
        ...
        <Select id="bioma" value={bioma} onChange={(e) => {
          const value = e.target.value;
          setBioma(value === '' ? '' : parseInt(value));
        }}>
